...
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<MyCustomViewHolder> {
    ...
    public MyCustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyCustomViewHolder holder = MyCustomViewHolder.createViewHolder(mContext, parent, layoutId);
    ...
    public void onViewHolderCreated(MyCustomViewHolder holder,View itemView){

    }

    public void convert(MyCustomViewHolder holder, T t) {
    ...
    protected void setListener(final ViewGroup parent, final MyCustomViewHolder viewHolder, int viewType) {
